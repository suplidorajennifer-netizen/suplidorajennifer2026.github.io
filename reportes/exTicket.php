...
$empresa = "Suplidora Jennifer S.A.";
$documento = "8847-5913";
$direccion = "Manzanillo-Costa de pajaros";
$telefono = "100metros oeste Del Bar la rana";
$email = "SuplidoraJennifer@hotmail.com";
	 ?>
...
<?php
    ...
    echo '<img src="https://localhost/files/logo/logo.jpg" alt="Suplidora Jennifer" class="Clase para la imágen" id="Identificador para la imágen" border="0" align="center" width="100px">';
...
?>
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			<td colspan="3" align="center">suplidorajennifer@hotmail.com</td>
		</tr>
		<tr>
			<td colspan="3" align="center">Manzanillo-Puntarenas</td>
		</tr>
	</table>
	<br>
</div>
